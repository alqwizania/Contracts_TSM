...
export default function DashboardCharts({ sectorBudgetStats, sCurveStats, classificationTreemapStats }) {
  return (
    <div className="charts-grid animate-fade-in">
      
      {/* 1. Sector Budget vs Spent Bar Chart */}
      <section className="glass-panel chart-card full-width-chart">
      ...
      <div className="two-charts-row">
        ...
        {/* 2. Portfolio S-Curve Line Chart */}
